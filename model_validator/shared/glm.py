...
class GLMManager:
    ...
    def graph_glm(self, node):
        ...
        # Eventually, we will identify nor_open from platform
        nor_open = ['swt_' + sw for sw in nor_open]
        component = ['transformer', 'regulator', 'triplex_line', 'overhead_line', 'switch']
        for key, value in self.model_dict.items():
            if value['object'] in component and value['name'].replace('"', '') not in nor_open:
